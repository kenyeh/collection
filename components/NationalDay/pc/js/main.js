...
var activity_2 = (function ($) {
    ...
    return {
        ...
        setProgressBar : function (act_data) {
            ...
            $userNum.text(act_data.user_amount).css("left",Number(100 + (7.3 * percentNum) - ($userNum.width()/2)) + "px");
        ...
        btnEnable : function () {
            ...
            $(".act2-deposit").removeClass("unable").prop("href", depositLink).click(function(){
                // deposit ga
                ga('send', 'event', 'PC活动页交互', window.location.pathname, '充值点击');
            });
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.state == 1) {
                            ...
                            // set stop wheel angle
                            var the_deg = (((360 / prizeList.length) * (PrizeID)));

                            // after 2 second slow down
                            setTimeout(function(){
                                // slow down
                                console.log('slow down');
                                $(".wheel").removeClass('go');

                                // rotate to the prize angle
                                $(".wheel").animateRotate((360 + the_deg), 1500, "easeOutSine", function(){
                                    ...
                                    $msg.fadeIn('fast',function(){
                                        ...
                                        setTimeout(function(){
                                            ...
                                            // reset angle and start normal run
